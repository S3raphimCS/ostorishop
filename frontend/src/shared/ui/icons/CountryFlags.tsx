...
export const RussiaFlag: ReactElement = (
  <svg
...
export const BelarusFlag: ReactElement = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="32"
    height="32"
  ...
  >
    <path
      d="M1,8v13H31V8c0-2.209-1.791-4-4-4H5c-2.209,0-4,1.791-4,4Z"
      fill="#be2d27"
    ></path>
    <path
      d="M5,20H27c2.208,0,4,1.792,4,4v4H1v-4c0-2.208,1.792-4,4-4Z"
    ...
    <path
      d="M5,6l-.645-1.935c-.27,.044-.53,.113-.779,.208l-.576,1.727,1,3,1-3Z"
      fill="#fff"
    ></path>
    <path
      d="M1.853,5.558c-.526,.677-.853,1.518-.853,2.442v1l1-3-.147-.442Z"
      fill="#fff"
    ></path>
    <path fill="#fff" d="M6.667 4L6 6 7 9 7 4 6.667 4z"></path>
    <path
      d="M5,26l-.645,1.935c-.27-.044-.53-.113-.779-.208l-.576-1.727,1-3,1,3Z"
      fill="#fff"
    ></path>
    <path
      d="M1.853,26.442c-.526-.677-.853-1.518-.853-2.442v-1l1,3-.147,.442Z"
      fill="#fff"
    ></path>
...
export const USAFlag: ReactElement = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="32"
    height="32"
...
export const ChinaFlag: ReactElement = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="32"
    height="32"
...
export const UnitedKingdomFlag: ReactElement = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="32"
    height="32"
